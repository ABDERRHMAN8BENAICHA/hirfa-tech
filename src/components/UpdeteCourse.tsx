...
export default function UpdeteCourse({ createdAt, description, discount, id, image, isFree, numberOfStars, price, published, title, updatedAt }: Props) {
    ...
    function onSubmit(data: z.infer<typeof FormSchema>) {
        ...
        fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/courses/${id}`, {
            method: "PUT",
            headers: {
