...
const VideoDropzone = React.forwardRef<HTMLInputElement, InputProps>(
            ...
            <div className='md:pl-12 pl-4'>
                ...
                >
                    ...
                    {videoUrl ? (
                        ...
                        <div className="flex flex-col items-center justify-center text-xs text-green-500">
                            <UploadCloudIcon className="mb-2 h-7 w-7" />
                            <div className="text-green-400">drag & drop to upload</div>
                            <div className="mt-3">
                                <Button className='text-green-500 hover:text-green-500' disabled={disabled}>select</Button>
                            </div>
                        </div>
                    )}
